use utf8;
package TreeFamDB::Result::PeptideAlignFeature;
...
TreeFamDB::Result::PeptideAlignFeature
...
=head1 TABLE: C<peptide_align_feature>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ga3T/f38zjsROQ41McVF4w
