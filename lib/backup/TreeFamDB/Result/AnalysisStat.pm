use utf8;
package TreeFamDB::Result::AnalysisStat;
...
=head1 TABLE: C<analysis_stats>

=cut

__PACKAGE__->table("analysis_stats");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bak14r7WdN1ftR2kEQZkug
