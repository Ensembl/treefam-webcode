...
sub convert_hmmer2json_tblout{
	...
	foreach my $line(split("\n",$result)){
		...
		print "target: ".	$line_hash{"target"}."\n";
		print "name: ".	$line_hash{"name"}."\n";
		print "model_length: ".	$line_hash{"model_length"}."\n";
		print "seq_length: ".	$line_hash{"seq_length"}."\n";
		print "evalue: ".	$line_hash{"evalue"}."\n";
		print "bits: ".	$line_hash{"bits"}."\n";
		print "seq from: ".	$line_hash{"seq"}{from}."\n";
		print "seq to: ".	$line_hash{"seq"}{to}."\n";
		print "seq name: ".	$line_hash{"seq"}{name}."\n";
		print "hmm from: ".	$line_hash{"hmm"}{from}."\n";
		print "hmm to: ".	$line_hash{"hmm"}{to}."\n";
		print "desc : ".	$line_hash{"desc"}."\n";
		if($line_hash{"evalue"} < 0.3){
...
sub convert_hmmer2json{
    ...
    #print Dumper %line_hash; 
		#die "here\n";
		#print "current evalue is ".	$line_hash{"evalue"}."\n";
		if($line_hash{"evalue"} < 0.001){
			#print " ".$line_hash{"evalue"}." < 0.3\n";
				push(@hits_array,\%line_hash);
			}
        }
	my $json_text   = to_json( \@hits_array, { ascii => 1, pretty => 1 } );
