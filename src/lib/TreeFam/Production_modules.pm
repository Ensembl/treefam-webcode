...
### do we need to clean old entry?
            ...
            my @tags_to_delete = ("fam_description", "fam_n_full", "hgnc", "fam_n_seed", "fam_full_description","fam_symbol", "fasta_aln", "homologs_array_json","numspecies","pfam","treenhx","treephyloxml","tree_image_png", "sequence_array_json","taxa_count","wikigene", "numSequences", "json_tree");
